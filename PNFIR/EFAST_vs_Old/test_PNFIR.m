...
legend('PNFIR');
%save ('PNFIR\data\ARMA\PNFIR_0.5_0.9_0.5.mat','avg_e');
%save ('PNFIR\data\rand\PNFIR_0.1_0.8_0.6.mat','avg_e');
%save('PNFIR\data\randn\PNFIR_0.1_0.8_0.6.mat','avg_e');
%save('PNFIR\data\randn\PNFIR_1_1_0.1.mat','avg_e');

%save('PNFIR\data\rand\PNFIR_test.mat','avg_e');
save('PNFIR\data\randn\PNFIR_test.mat','avg_e');
%save('PNFIR\data\ARMA\PNFIR_test.mat','avg_e');